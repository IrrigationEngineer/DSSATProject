...
public class SoilDataGenerator {   
    ...
    public void ReadSoilData (String countyName, String soilid) {        

        String filepath = datadir+dirseprator+soilid+".SOL";
        //System.out.println (SoilDataGenerator);
        String datastring = "*" + soilid;
        System.out.println(filepath);
        boolean isdatablock = false;
        try {
            
	    BufferedReader in = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("/dssat/properties/csv/FL.SOL")));
